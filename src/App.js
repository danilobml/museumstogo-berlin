...
function App() {
  ...
  //returns new array minus the museum being deleted and sets that to the state. also runs local storage, as with all events which change the museum state.
    ...
    <div className="App">
      <div className="container">
        ...
        <div className="clear-div">
          {museums.find((m) => m.name) ? <ClearAll handleClearAll={handleClearAll} /> : ""}
